...
/// </summary>
[CreateAssetMenu(fileName="InfosDuJoueur", menuName="Infos du joeur")] //consigne de creation du menu de creation de l'asset
public class InfosJoueur : ScriptableObject //preciser que c'est un S.O.
{
    //DEBUT DES CHAMPS SERIALISES
    [Header("Valeurs initales")] //Entete de section pour les Valeurs initiales (debut de partie)
    ...
    [SerializeField] private string _nom = "Prénom"; //nom durant la partie
    [SerializeField] private int _vie = 3; //int, nb de vies du joueur durant la partie
    [SerializeField] private int _score = 0; //int, score du joueur durant la partie
